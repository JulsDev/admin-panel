        ...
        <div className='col s1 m5'>
          <div className='card' style={cardStyle}>
            <div className='card-content black-text'>
              ...
              <p>
                <span style={{ fontWeight: 700 }}>Телефон:</span> {managerInfo.phone}
              </p>
              <p style={{ marginBottom: '10px' }}>
                <span style={{ fontWeight: 700 }}>Email:</span> {managerInfo.email}
              </p>
              <p>
                <span style={{ fontWeight: 700 }}>Учредители:</span>
              </p>
        ...
        <div className='col s1 m5'>
          <div className='card' style={cardStyle}>
            <div className='card-content black-text'>
              ...
              <p style={{ marginBottom: '10px' }}>
                <span style={{ fontWeight: 700 }}>Email:</span> {contacts.email}
              </p>
              <p>
